...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mini_ecommerce_backend.Entities.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("mini_ecommerce_backend.Entities.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("mini_ecommerce_backend.Entities.Orders.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("mini_ecommerce_backend.Entities.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Products", t =>
                        {
                            t.HasCheckConstraint("CK_Product_Price_Quantity_Valid", "[Price] > 0 AND [Quantity] >= 0");
                        });
                });
            ...
            modelBuilder.Entity("mini_ecommerce_backend.Entities.Orders.OrderItem", b =>
                {
                    b.HasOne("mini_ecommerce_backend.Entities.Orders.Order", null)
                        .WithMany("Items")
