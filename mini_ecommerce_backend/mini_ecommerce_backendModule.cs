...
public class mini_ecommerce_backendModule : AbpModule
{
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(mini_ecommerce_backendResource)
            );
        });
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("mini_ecommerce_backend");
    ...
    {
        context.Services.Addmini_ecommerce_backendHealthChecks();
    }
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(mini_ecommerce_backendModule).Assembly;
        });
    }
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new mini_ecommerce_backendMenuContributor());
        });
    }
    ...
    private void ConfigureLocalization()
    {
        ...
        {
            options.Resources
                .Add<mini_ecommerce_backendResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource), typeof(AbpUiResource))
                .AddVirtualJson("/Localization/mini_ecommerce_backend");

            options.DefaultResourceType = typeof(mini_ecommerce_backendResource);
        ...
        {
            options.MapCodeNamespace("mini_ecommerce_backend", typeof(mini_ecommerce_backendResource));
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(mini_ecommerce_backendModule).Assembly);
        });
    }
    ...
    private void ConfigureSwagger(IServiceCollection services)
    {
        services.AddAbpSwaggerGen(
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "mini_ecommerce_backend API", Version = "v1" });
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<mini_ecommerce_backendModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<mini_ecommerce_backendModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    {
        context.Services.AddAbpDbContext<mini_ecommerce_backendDbContext>(options =>
        {
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "mini_ecommerce_backend API");
        });
